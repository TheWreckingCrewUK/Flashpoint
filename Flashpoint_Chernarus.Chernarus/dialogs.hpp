...
{
	idc = 1602;
	action = "[player] call twc_fnc_getSupplies";
...
{
	idc = 1600;
	action = "closeDialog 0; player setVariable [""twc_spawningHelo"", true];";
...
{
	idc = 1600;
	action = "closeDialog 0; player setVariable [""twc_spawningVehicle"", true];";
